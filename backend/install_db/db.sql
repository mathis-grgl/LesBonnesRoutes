...
DROP TRIGGER IF EXISTS NOTIF_GROUPE_INSERT;
...
CREATE TRIGGER NOTIF_GROUPE_INSERT AFTER INSERT ON NOTIF_GROUPE
BEGIN
  INSERT INTO NOTIF_RECUE (idCompte, idNotification)
  SELECT idCompte, new.idNotification FROM AMI_GROUPE
  WHERE idGroupe = new.idGroupe;
END;
